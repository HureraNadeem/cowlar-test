...
const OwnMovieCard: FC<Props> = ({ name, releaseYear, imgUrl, id, setIsPageLoading, setReFetch }) => {
    ...
    return (
        <>
            <div className=' shadow-lg select-none border border-black/35 group hover:border hover:border-primaryRed rounded-lg max-h-fit w-[230px] transition ease-in-out delay-100 hover:scale-105'>
