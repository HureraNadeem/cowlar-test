...
const BasicButton: React.FC<Props> = ({
    ...
    ${disabled ? 'bg-gray-500 cursor-not-allowed' : `${color ? 'bg-orange-700 hover:bg-orange-800 focus:ring-orange-300' : 'bg-primaryRed hover:bg-secondaryRed'} focus:ring-4 focus:outline-none`}`;
