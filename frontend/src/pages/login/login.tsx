                ...
                >
                    <div className='w-full rounded-lg bg-backgroundBlack shadow sm:max-w-md md:mt-0 xl:p-0'>
                        <div className='space-y-4 p-6 sm:p-8 md:space-y-6'>
                            <h1 data-testid="login-heading" className='text-xl font-bold leading-tight tracking-tight  md:text-2xl'>
                                Log in
                            </h1>
                            <form
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        type='email'
                                        id='email'
                                        className='block w-full rounded-lg border border-gray-300 bg-[#292929] p-2.5  focus:border-primary-600 focus:ring-primary-600 sm:text-sm'
