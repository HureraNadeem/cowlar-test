                    ...
                    <div className='flex flex-col'>
                        <div className='flex justify-center flex-wrap gap-3 sm:justify-between'>
                            ...
                            <div className='flex gap-4'>
                                <button
                                    type='button'
                                    className='text-white bg-primaryRed hover:bg-secondaryRed font-medium rounded-lg text-sm px-4 py-2 text-center'
                                    onClick={openModal}
                                >
                        ...
                        <div className='py-5 flex items-end justify-center'>
                            <form onSubmit={handleSubmit(reFetchMovies)}>
                                ...
                                <div className='relative w-[75vw] sm:w-[500px]'>
                                    ...
                                    <button
                                        type='submit'
                                        className='text-white absolute end-2.5 bottom-2.5 ml-16 bg-primaryRed hover:bg-secondaryRed font-medium rounded-lg text-sm px-4 py-2'
                                    >
                                        Search
                                    </button>
                                </div>
